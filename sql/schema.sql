...
-- Check-ins: weekly client submissions
...
-- Messages: full audit trail of all WhatsApp messages
...
-- Escalations: flagged items for Maddy's review
...
-- Enable Row Level Security (disabled for service role access from backend)
