...
-- Enable RLS (policies managed via Supabase dashboard for admin auth)
...
-- Service role bypasses RLS, so API endpoints work fine
-- Admin dashboard uses Supabase Auth + policies
