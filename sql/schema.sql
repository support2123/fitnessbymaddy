...
-- Create Supabase Storage bucket for client files
-- Run separately: INSERT INTO storage.buckets (id, name, public) VALUES ('clients', 'clients', false);
...
CREATE POLICY "Service role full access" ON nudges FOR ALL USING (true) WITH CHECK (true);
