...
-- Clients table: converted paying customers
...
-- Enable Row Level Security (tables accessed via service key in serverless, so we add policies later if needed)
...
-- Service role bypass (for serverless functions using SUPABASE_SERVICE_KEY)
