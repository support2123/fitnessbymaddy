...
CREATE POLICY "service_full_access_clients" ON clients FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "service_full_access_checkins" ON checkins FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "service_full_access_programs" ON programs FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "service_full_access_messages" ON messages FOR ALL USING (true) WITH CHECK (true);
