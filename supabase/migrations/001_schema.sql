-- ============================================================
-- FitnessByMaddy schema migration
-- ============================================================
...
-- Service-role bypass policies (the API uses the service key)
...
-- Authenticated user read-only policies (for admin dashboard)
...
CREATE POLICY "authenticated_read_checkins" ON checkins
  FOR SELECT USING (auth.role() = 'authenticated');
