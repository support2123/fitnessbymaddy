...
-- Generated programs (weekly PDFs for 12-week clients)
...
-- Service role policies (API uses service key, so full access)
CREATE POLICY "Service full access on leads" ON leads FOR ALL USING (true);
CREATE POLICY "Service full access on clients" ON clients FOR ALL USING (true);
CREATE POLICY "Service full access on checkins" ON checkins FOR ALL USING (true);
CREATE POLICY "Service full access on programs" ON programs FOR ALL USING (true);
CREATE POLICY "Service full access on messages" ON messages FOR ALL USING (true);
CREATE POLICY "Service full access on escalations" ON escalations FOR ALL USING (true);
