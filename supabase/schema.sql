...
-- Check-ins table: weekly progress submissions
...
-- Programs table: generated weekly plans (12-week clients)
...
-- Messages table: full audit trail of all WhatsApp comms
...
-- Enable Row Level Security (tables accessed via service key from serverless functions)
...
-- Service role bypass policies (serverless functions use service key)
