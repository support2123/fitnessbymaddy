...
create index if not exists checkins_client_week on checkins (client_id, week_no);
...
create index if not exists programs_client_week on programs (client_id, week_no);
...
-- ─── ROW LEVEL SECURITY ────────────────────────────────
-- Service-role key bypasses RLS; these are just safety rails
...
-- ─── STORAGE BUCKET ────────────────────────────────────
-- Run separately in Storage settings or via:
