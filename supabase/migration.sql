...
CREATE POLICY "Service key full access" ON leads FOR ALL USING (true);
CREATE POLICY "Service key full access" ON clients FOR ALL USING (true);
CREATE POLICY "Service key full access" ON checkins FOR ALL USING (true);
CREATE POLICY "Service key full access" ON programs FOR ALL USING (true);
