...
CREATE INDEX IF NOT EXISTS idx_escalations_pending ON escalations (resolved, created_at DESC);

-- Row-level security (enable on all tables, service key bypasses)
