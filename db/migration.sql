...
CREATE POLICY "Service key full access on leads" ON leads FOR ALL USING (true);
CREATE POLICY "Service key full access on clients" ON clients FOR ALL USING (true);
CREATE POLICY "Service key full access on checkins" ON checkins FOR ALL USING (true);
CREATE POLICY "Service key full access on programs" ON programs FOR ALL USING (true);
CREATE POLICY "Service key full access on messages" ON messages FOR ALL USING (true);
