...
-- CHECKINS: weekly progress snapshots
...
-- PROGRAMS: generated weekly plans
...
-- MESSAGES: full audit trail of all WhatsApp comms
...
-- ESCALATIONS: flagged items for Maddy
...
CREATE POLICY "service_all" ON escalations FOR ALL USING (true) WITH CHECK (true);
