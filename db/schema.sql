...
-- Service role can do everything (used by Vercel functions)
...
-- Lead intake forms (extended profile data)
...
CREATE POLICY "service_all_lead_intakes" ON lead_intakes FOR ALL USING (true) WITH CHECK (true);
