...
-- Nudge tracking (prevent duplicate nudges)
...
CREATE INDEX idx_nudges_lead ON nudges(lead_id);
...
CREATE POLICY "Allow service role full access" ON clients FOR ALL USING (true);
CREATE POLICY "Allow service role full access" ON checkins FOR ALL USING (true);
CREATE POLICY "Allow service role full access" ON programs FOR ALL USING (true);
CREATE POLICY "Allow service role full access" ON messages FOR ALL USING (true);
CREATE POLICY "Allow service role full access" ON nudges FOR ALL USING (true);
CREATE POLICY "Allow service role full access" ON escalations FOR ALL USING (true);
