...
-- Clients table: paid / active participants
...
-- Generated programs (12-week clients)
...
-- Enable Row Level Security (tables accessed only via service key from serverless)
