...
-- Check-ins: weekly progress submissions
...
-- Messages: full audit trail of WhatsApp comms
...
-- Escalations: flagged for Maddy's review
...
-- Service role policies (Vercel functions use service key)
