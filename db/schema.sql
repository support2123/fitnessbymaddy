...
-- Clients table: paid / converted leads
...
-- Checkins table: weekly client submissions
...
-- Messages table: full audit trail of all WhatsApp messages
...
-- Escalations table: flagged items for Maddy
