...
function classifyIntent(message) {
  ...
  if (/\b(pcos|hormonal|hormone|irregular)\b/.test(lower)) return 'pcos';
  if (/\b(40|forty|menopause|joint|joints|senior|mature)\b/.test(lower)) return '40plus';
  if (/\b(custom|12\s*week|serious|flagship|personalise|personalize)\b/.test(lower)) return '12wk';
...
const ESCALATION_KEYWORDS = [
  ...
  'medical', 'surgery', 'doctor', 'hospital',
];
