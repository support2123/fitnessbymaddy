...
const { needsEscalation, createEscalation, checkMissedCheckins } = require('./_lib/escalation');
  ...
  try {
    ...
    if (issues) {
      ...
      if (escalationKeyword) {
        await createEscalation(client.phone, client_id, `Check-in: ${escalationKeyword}`, issues);
      }
    }
    ...
    console.log(`Check-in submitted: client ${maskPhone(client.phone)}, week ${week_no}`);
