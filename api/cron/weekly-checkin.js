...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    for (const client of activeClients) {
      ...
      const msg = market === 'IN'
        ? `Hey ${client.name || 'there'}! 📋 Week ${weekNo} check-in time!\n\nApna progress share karo — weight, waist, photos.\n👉 ${checkinUrl}\n\nYe important hai taaki tera next week ka plan aur better ho!`
        : `Hey ${client.name || 'there'}! 📋 Time for your Week ${weekNo} check-in!\n\nShare your progress — weight, waist, photos.\n👉 ${checkinUrl}\n\nThis helps us optimize your next week's plan!`;
