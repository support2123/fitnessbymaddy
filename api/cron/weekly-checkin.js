  ...
  try {
    ...
    for (const client of activeClients) {
      try {
        ...
        await logMessage(client.phone, 'out', `Weekly check-in form sent (week ${weekNo})`, 'weekly_checkin');
        sent++;
      } catch (clientErr) {
        errors.push({ client: maskPhone(client.phone), error: clientErr.message });
      }
    }
