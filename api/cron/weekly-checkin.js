    ...
    for (const client of clients) {
      ...
      if (consecutiveMissed >= 2) {
        await escalateToMaddy('missed_checkins', {
          phone: client.phone,
          message: `${client.name} missed ${consecutiveMissed} consecutive check-ins (current week: ${currentWeek})`
        });
        escalated++;
      }
      ...
      await logMessage(client.phone, 'out', `[Weekly check-in W${currentWeek}]`, 'weekly_checkin');
      sent++;
    }
