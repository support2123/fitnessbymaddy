...
CREATE INDEX IF NOT EXISTS idx_checkins_submitted ON checkins (form_submitted_at);

-- Generated programs (weekly, primarily for 12-week clients)
...
-- Escalations table for flagged items
...
CREATE POLICY "Service full access" ON leads FOR ALL USING (TRUE) WITH CHECK (TRUE);
CREATE POLICY "Service full access" ON clients FOR ALL USING (TRUE) WITH CHECK (TRUE);
CREATE POLICY "Service full access" ON checkins FOR ALL USING (TRUE) WITH CHECK (TRUE);
CREATE POLICY "Service full access" ON programs FOR ALL USING (TRUE) WITH CHECK (TRUE);
CREATE POLICY "Service full access" ON messages FOR ALL USING (TRUE) WITH CHECK (TRUE);
CREATE POLICY "Service full access" ON escalations FOR ALL USING (TRUE) WITH CHECK (TRUE);
