...
CREATE POLICY "service_full_access" ON leads FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "service_full_access" ON clients FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "service_full_access" ON checkins FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "service_full_access" ON programs FOR ALL USING (true) WITH CHECK (true);
