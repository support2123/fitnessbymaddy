...
CREATE POLICY "Service key full access" ON leads FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Service key full access" ON clients FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Service key full access" ON checkins FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Service key full access" ON programs FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Service key full access" ON messages FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Service key full access" ON intake_forms FOR ALL USING (true) WITH CHECK (true);
