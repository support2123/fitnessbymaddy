...
-- LEAD INTAKE (onboarding form data)
...
-- Create a bucket named 'client-files' with public access
...
-- Admin users can read everything via dashboard
...
CREATE POLICY "Authenticated read" ON lead_intake FOR SELECT TO authenticated USING (true);
